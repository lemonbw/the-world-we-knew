...
export default function Panel() {
  ...
  return (
    <div className={`z-5 mt-30 ${section === 'Overview' ? "-mb-10 lg:-mb-6" : ""} flex h-9 w-35 *:text-[1.2rem] overflow-hidden rounded-[0.55rem] border-2 *:w-1/2 *:pt-[0.2rem] *:pl-[0.3rem] *:text-center lg:h-10 lg:w-55 lg:rounded-xl lg:*:pl-4`}>
      <Link
        href="/"
