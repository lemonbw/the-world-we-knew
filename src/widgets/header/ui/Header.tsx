...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      />
      <nav
        className={`absolute z-5 flex-col justify-between bg-white lg:static lg:flex lg:translate-x-0 lg:flex-row dark:bg-black ${hiddenNavigation ? 'translate-x-full' : 'translate-x-0'} mt-3 mb-4 -ml-2 w-full pl-2 text-[1.3rem] font-medium duration-300 lg:ml-0 lg:pl-0 ${hiddenHeader ? 'translate-x-full' : 'translate-x-0'} mt-10`}
      >
