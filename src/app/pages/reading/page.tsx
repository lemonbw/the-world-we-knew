...
import AlignSelector from "../../components/Reading/Align/AlignSelector"
...
export default function ReadingPage() {
  ...
  return (
    <Main>
      ...
      >
        <div className="w-[70vw] h-10 flex flex-none justify-center gap-1 mx-auto mb-2">
          <button
