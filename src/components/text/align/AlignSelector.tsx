...
export function AlignSelector({ currentAlign, setCurrentAlign }: AlignSelectorProps) {
  return (
    <div className="flex gap-1 *:text-[1.7rem]! mt-1 *:border-1 *:border-black *:hover:border-white/10 *:rounded-sm *:duration-300 *:w-10 w-30">
