...
export const Panel = () => {
  ...
  return (
    <div
      className="flex h-9 w-35 overflow-hidden rounded-[0.55rem] border-2 *:w-1/2 *:pt-[0.2rem] *:pl-[0.3rem] *:text-center *:text-[1.2rem] lg:mt-10 lg:h-10 lg:w-55 lg:rounded-xl lg:*:pl-4"
    >
      <Link
        href="/"
